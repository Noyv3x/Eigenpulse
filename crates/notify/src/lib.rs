...
/// Read at most 4 KiB from an untrusted provider error response. Some webhook
/// endpoints otherwise allow an unbounded chunked body to hold a worker and
/// grow the process indefinitely.
#[cfg(feature = "ssr")]
pub(crate) async fn capped_response_text(mut response: reqwest::Response) -> String {
...
#[cfg(feature = "ssr")]
pub use channels::{
    create_channel, delete_channel, list_channels, test_channel, validate_notifier_config,
    NotifyChannelSummary, MAX_CHANNEL_NAME_CHARS,
};
