...
fn discover_bundles(root: &Path) -> Vec<Bundle> {
    ...
    for sub in ["crates", "modules", "app"] {
            ...
            .filter(|e| e.file_type().is_dir())
        {
            ...
            // Only workspace crates contribute runtime catalogs.
...
/// `crates/i18n` owns cross-cutting `app.common.*` keys; module namespaces
/// otherwise match their crate directory names.
