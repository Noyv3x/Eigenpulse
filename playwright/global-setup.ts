...
//
// Set EP_SKIP_BUILD=1 to skip the build — CI does this because it runs
// `cargo leptos build --release` in a dedicated, cached step before invoking
// playwright. In that case we just assert the artifacts exist.
